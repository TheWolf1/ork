...
class HomeController extends Controller
{
    ...
    public function __invoke(Request $request)
    {
        ...
        $caja = Caja::where('created_at','>',$dateTimeInit)->where('created_at','<',$dateTimeFin)->where("caja_id",Auth::id())->first();
        ...
        $mesas= Mesa::all();
        return view('pages.home',compact('products','pedidosSinPagar','mesas','pedidosPagos','pedidosTotal','gastos','pedidosSPListos','caja'));
